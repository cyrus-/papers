...
It follows by induction that either $S_1 \sreduces \err$, $S_2 \sreduces \err$, 
...
By induction, $S_1 \sreduces \err$ or $S_1 \sreduces \rstr{s}$.
In the former case $S \sreduces \err$ by propagation rules.
...
If $s \not \in \lang{r}$ then $S \sreduces \err$. 
\end{description}
\end{proof}
