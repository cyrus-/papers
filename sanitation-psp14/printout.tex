\documentclass[8pt]{sig-alternate}
...
Note that \textsc{S-E-Abs} and \textsc{S-E-App} are excluded from Figure~\ref{fig:slambdas} due to space constraints. However, they resemble the corresponding rules for $\lambdap$; see the paper for a full definition.
