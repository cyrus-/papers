...
\todo{if there's time add the proof...}
...
\item \textbf{Case $e = \rconcat{e_1}{e_2}$}. \todo{hand wave lots and lots of symbol pushing.} By induction.
...
\todo{hand wave} The result follows by induction.
