...
%
%If $e$ steps by L-E-AppLeft then $e_1(e_2) \mapsto e_1'(e_2)$.
%By induction, $e_1' \sreduces \lambda x . e_3$.
%By S-E-App, $e_1'(e_2) \sreduces \lambda x . e_3$.
%
%If $e$ steps by L-E-AppRight then $e_1(e_2) \mapsto e_1(e_2')$.
%By induction, $e_2' \sreduces v_2$.
%By S-E-App, $e_1(e_2') \sreduces \lambda x . e_3$.
%
%If $e$ steps by L-E-AppAbs then $e = (\lambda x . e_3)(v_2) \mapsto [v_2 / x]e_3$.
...
%
%If $e_1 \mapsto e_1'$ and $e_2 = v_2$
%then $e \mapsto e_1'(v_2)$ by L-E-AppLeft.
%The conclusion follows by Lemma \ref{lem:inductive}???
%Similarly, if $e_2 \mapsto e_2'$ then
%$e \mapsto e_1'(e_2)$ by L-E-AppLeft.
%The conclusion follows by Lemma \ref{lem:inductive}???
