...
\abstract{This report contains supporting evidence for claims put forth and explained in the paper ``Statically Typed String Sanitation Inside a Python'' \cite{fulton2014}\todo{fix this}, including proofs of lemmas
...
By PS-E-AppAbs, we have that $(\lambda x : \trden{\sigma}. \trden{e'})\trden{v_2} \mapsto [\trden{v_2}/x]\trden{e'}$.\todo{define multistep semantics}
...
\item \textbf{Case SS-E-Case-$\epsilon$-Val}.\todo{rename this rule}
...
\item \textbf{Case SS-E-Case-Concat}.\todo{rename this rule}
