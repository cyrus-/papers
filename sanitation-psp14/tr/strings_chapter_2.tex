...
\end{thm}
\begin{proof}
By induction on the typing and evaluation relations.
...
where $\sctx \vdash e_1 : \sigma_2 \rightarrow \sigma$ 
and $\sctx \vdash e_2 : \sigma_2$.
$e \mapsto e'$ by either SS-E-AppLeft or SS-E-AppAbs.
In any case, $\trden{e} \mapsto \trden{e'}$ by induction and the corresponding
PS-E rule.

\item \textbf{Case S-T-Concat-Left}.
Suppose $\sctx \vdash \rconcat{e_1}{e_2} : \stringin{r_1\cdot r_2}$ where
$\sctx \vdash e_1 : \stringin{r_1}$ and $\sctx \vdash e_2 : \stringin{r_2}$.
Suppose also $\rconcat{e_1}{e_2} \mapsto e'$, which could only happen via
SS-E-ConcatLeft, SS-E-ConcatRight, or SS-E-Concat.

In the first case, $\rconcat{e_1}{e_2} \mapsto \rconcat{e_1'}{e_2}$ when
$e_1 \mapsto e_1'$. By induction, $\trden{e_1} \mapsto \trden{e_1'$.
Therefore, $e \mapsto \tconcat{\trden{e_1'}{\trden{e_2}$ by PS-E-ConcatLeft.

In the second case, $\rconcat{e_1}{e_2} \mapsto \rconcat{e_1}{e_2'}$ when
$e_2 \mapsto e_2'$. By induction, $\trden{e_2} \mapsto \trden{e_2'}$.
\todo{stop here.}
...
{   \trden{e_1} = \iota_1 \\   \trden{e_2} = \iota_2 }
{   \trden{ \sisubst{r}{e_1}{e_2} } = \preplace{\rx{r}}{\iota_1}{\iota_2} }
...
{ 
  \trden{ \rcheck{r}{e}{x.e_1}{e_2} } = \tcheck{\rx{r}}{\iota}{(\lambda x : \str. \iota_1)(\iota)}{\iota_2} 
} 
\end{mathpar}
