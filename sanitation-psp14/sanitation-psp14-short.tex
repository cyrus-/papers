...
{
  \pstrcase{\iota_1}{\iota_2}{\iota_3} \treduces \dot{v_2}
}
...
{\iota \treduces \tstr{s} \\ 
s \in \lang{r} \\ 
\iota_1 \sreduces \dot{v_1}
}
{
  \tcheck{\rx{r}}{\iota}{\iota_1}{\iota_2} \treduces \dot{v_1}
}

\inferrule[P-E-Check-NotOK]
{\iota \treduces \tstr{s} \\ s \not \in \lang{r} \\ \iota_2 \treduces \dot{v_2}}
{\tcheck{\rx{r}}{\iota}{\iota_1}{\iota_2} \treduces \dot{v_2}}
\end{mathpar}
