...
An alternative to coercion is subtyping for constrained string types. For simplicity, we do not include this relation; however, subtyping for constrained strings is present in \cite{fulton13} and that treatment extends to this system.
