...
Web applications must ultimately command systems like web browsers and database engines using strings. Strings constructed using user input that has not been properly sanitized can thus cause command injection vulnerabilities. %Structured frameworks for constructing commands centralizes control over string sanitization, but verifying that the framework itself sanitizes user input correctly can still be tricky.
