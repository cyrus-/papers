...
We differ from this and related work in at least two ways. First, our system  is defined within an extensible type system; second, and more importantly, we have demonstrated that regular expression types are applicable to the web security domain.
...
Operations on expressions of type $\stringin{r}$ preserve this property; for instance,
the result of string concatenation is 
