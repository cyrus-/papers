...
The main theorem of this paper is Theorem \ref{thm:main}. Establishing this result requires an additional theorem (Theorem \ref{tcorrect}), which establishes a relationship between canonical forms for the string fragments of $\lambdas$ and $\lambdap$.
...
also support complementation using the carot.

TODO-nrf insert a pargraph or two which explains what's going on... 
...
double quotes and left and right brackets. In this example, we use HTML
escape sequences; many variants of SQL provide their own syntax
for this as well.

TODO-nrf line by line of example.

\subsection{Extension Implementation}

TODO-nrf line by line of extension implementation as ewll.
