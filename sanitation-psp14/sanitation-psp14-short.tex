...
\footnote{For the reader's convienance, a single sheet containing figures \ref{fig:glambdas}-\ref{fig:tr} is available at http://nfulton.org/strings/printout.pdf \todo{post this}}.
