...
~
\begin{enumerate}
\item If $s_1 \in \lang{r_1}$ and $s_2 \in \lang{r_2}$ then $s_1s_2 \in \lang{r_1r_2}$.
...
\begin{lemma}[Canonical Forms for String Fragment of $\lambdas$]\label{thm:cfs}
...
such as \textbf{P}ython or \textbf{P}HP. We will discuss an implementation within the former in the next section.
