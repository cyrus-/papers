...
\todo{outline of \S 2 goes here}

\subsection{The Language of Constrained Strings: $\lambdas$}
...
\subsubsection{Definition of Substitution and Replacement for Regular Languages}

\subsubsection{Safety}

\subsubsection{The Security Theorem}

\subsection{A Target Language with a Regular Expression Library: $\lambdap$}

\subsubsection{Safety}

\subsection{Translation from $\lambdas$ to $\lambdap$}
...
If $\sctx \vdash e : \stringin{r}$ then there exists an $\iota$ such that $\trden{e} = \iota$, 
