...
\newcommand{\lsubst}[3]{{\tt subst}(#1;#2;#3)} % This used to renderlreplace(...) so there're probably mistkes wherever this command was used now.
...
\inferrule[P-T-Check]
{\tctx \vdash \iota_1 : \regex \\ \tctx, x:\str \vdash \iota_2 : \sigma \\ \tctx \vdash \iota_3 : \sigma}
{\tctx \vdash \tcheck{\iota_1}{x.\iota_2}{\iota_3} : \sigma}
\end{mathpar}
...
\inferrule[P-E-App]
{ \iota_1 \sreduces \iota_1' \\  \iota_2 \sreduces \iota_2' }
{ \iota_1(\iota_2) \sreduces \iota_1'(\iota_2')}
...
{i \treduces \str{s} \\ s \in \lang{r}}
{\tcheck{r}{i}{x.i_1}{i_2} \treduces [\str{s}/x]i_1}

\inferrule[P-E-Check-NotOK]
{i \treduces \str{s} \\ s \not \in \lang{r}}
{\tcheck{r}{i}{x.i_1}{i_2} \treduces i_2}
