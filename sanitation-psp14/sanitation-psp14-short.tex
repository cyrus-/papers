...
{ e : \strin{r} \\ \lang{r'} \subseteq \lang{r}}
{\trden{ \coerce{r'}{e} } = \tstr{s}}

\inferrule[Tr-Coerce-NotOk]
{\trden{e} = \iota \\ e : \strin{r} \\ \lang{r'} \not \subseteq \lang{r}}
{\trden{\coerce{r'}{e}} = \tcheck{\rx{r'}}{\iota}}
...
\begin{thm}{Correctness of Input Sanitation for $\lambdas$.}\label{thm:scorrect}
  If  $\sctx \vdash e : \stringin{r}$ and $e \sreduces \rstr{s}$ then $e \in \lang{r}$.
\end{thm}
\begin{proof}
...
If $\sctx \vdash e : \stringin{r}$ then there exists a $\iota$ such that $\trden{e} = \iota$ such that 
$iota \treduces \tstr{s}$ and $e \sreduces \strin{s}$, or
\end{thm}
