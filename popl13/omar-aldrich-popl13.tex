...
\textbf{internal terms} 				& 	\mu	&	::=	&	\ivar{u} \pipe 
												\ilam{\ivar{u}}{\psi}{\mu} \pipe 
												\ifix{\ivar{f}}{\psi}{\mu} \pipe 
...
\tentailsX{\delrep}\\
\tentails{\tvarCtx, \tof{\tvar{t}}{\kType{fam}}}{\theta}
}{
	\tentailsXt{\ttypestd}{\kType{fam}}
} ~(\text{Type}_I)

\inferrule{
	\tentailsXt{\psi}{\kType{fam}}
}{
...
\inferrule{
	...
	\tentailsXt{\psi_0}{\karrow{\kType{fam}}{\kappa}}\\
	\tentailsXt{\psi_1}{\kappa}
}{
	\tentailsXt{\tfamcase{\psitype}{fam}{\psi_0}{\psi_1}}{\kappa}
}~(\text{idxcase})
\\
\inferrule{
	\mentails{\Delta}{\cdot}{\mu}\\
	\tentailsXt{\psitype}{\kType{fam}}
}{
	\tentailsXt{\tden{\mu}{\psitype}}{\kDenk{fam}}
}~(\text{Den}_I)
...
\inferrule{
	...
	\tentailsXt{\ttypeof{\psi}}{\kType{fam}}
}

\inferrule{
	\tentailsXt{\psiden}{\kDen}\\
	\tentailsXt{\psi_0}{\karrow{\kDenk{fam}}{\kappa}}\\
	\tentailsXt{\psi_1}{\kappa}
}{
...
\end{mathpar}
$\fbox{\inferrule{}{\eentails{\tvarCtx}{\itvarCtx}{\mu}}}$
...
\inferrule{
	...
	\mentails{\tvarCtx}{\itvarCtx, u}{\mu}
}{
	\mentailsX{\ilam{\ivar{u}}{\delta}{\mu}}
}~(\text{$\lambda$-form}^{\mu})

\inferrule{
	\tentails{\tvarCtx}{\delta}\\
	\mentails{\tvarCtx}{\itvarCtx, \ivar{f}}{\mu}
}{
	\mentailsX{\ifix}{\ivar{f}}{\delta}{\mu}
}~(\text{fix-form}^\mu)
...
\inferrule{
	...
	\mentailsX{\iIfEq}{\mu_1}{\mu_2}{\mu_3}{\mu_4}
}~(\text{if-form}^\mu)

\inferrule{ }{\mentailsX{\iintlit}}~(\text{int-form}^\mu)

\inferrule{
	\mentailsX{\mu_1}\\
	\mentailsX{\mu_2}
}{
	\mentailsX{\iop{\mu_1}{\mu_2}}
}~(\text{+-form}^\mu)
...
%	\tentailsXt{\psi_{1}}{\kappa_{1}}
%}{
%	\tentailsXt{\tfamcase{\psi}{\kappa_{0}}{\psi_{0}}{\psi_{1}}}{\kappa_{1}}
%}~~~~
%\inferrule{
...
%~~~~$\ivarCtx ::= \cdot \pipe \ivarCtx, \ivar{u}$
%\begin{mathpar}
%\inferrule{
%	\ivar{u} \in \ivarCtx
%}{
...
%\inferrule{
%	\tentailsXt{\psi}{\kIType}\\
%	\mentails{\kvarCtx}{\labelCtx}{\tvarCtx}{\ivarCtx, \ivar{u}}{\mu}
%}{
%	\mentailsX{\ilam{\ivar{u}}{\psi}{\mu}}
%}
%
%\inferrule{
%	\tentailsXt{\psi}{\kIType}\\
%	\mentails{\kvarCtx}{\labelCtx}{\tvarCtx}{\ivarCtx, \ivar{f}}{\mu}
%}{
%	\mentailsX{\ifix{\ivar{f}}{\psi}{\mu}}
%}
%
%\inferrule{
%	\mentailsX{\mu_{1}}\\
...
%	\mentailsX{\mu_{3}}
%}{
%	\mentailsX{\iIfEq{\mu_{0}}{\mu_{1}}{\mu_{2}}{\mu_{3}}}
%}
%\end{mathpar}
...
%}{
%	\tevals{\tfamcase{\psi}{\kappa}{\psi_{0}}{\psi_{1}}}{\psi'}{\Sigma_{0},\Sigma_{1}}
%}
%
%\inferrule{
%	\tevals{\psi}{\ttype{\psiidx}{\kappa'}{\psirep}}{\Sigma_{0}}\\
...
%}{
%	\tevalms{\ilam{\ivar{u}}{\psi}{\mu}}{\ilam{\ivar{u}}{\psi'}{\mu'}}{\Sigma_{0},\Sigma_{1}}
%}
%
%\inferrule{
%	\tevals{\psi}{\psi'}{\Sigma_{0}}\\
%	\tevalms{\mu}{\mu'}{\Sigma_{1}}
%}{
%	\tevalms{\ifix{\ivar{f}}{\psi}{\mu}}{\ifix{\ivar{f}}{\psi'}{\mu'}}{\Sigma_{0},\Sigma_{1}}
%}
%
%\inferrule{
...
%}{
%	\tevalms{\iapp{\mu_1}{\mu_2}}{\iapp{\mu_1'}{\mu_2'}}{\Sigma_{0},\Sigma_{1}}
%}
%
%\inferrule{ }{
...
%	\tevalms{\mu_2}{\mu_2'}{\Sigma_{1}}
%}{
%	\tevalms{\iop{\mu_1}{\mu_2}}{\iop{\mu_1'}{\mu_2'}}{\Sigma_{0},\Sigma_{1}}
%}
%
%\inferrule{
%	\tevalms{\mu_1}{\mu_1'}{\Sigma_{0}}\\
%	\tevalms{\mu_2}{\mu_2'}{\Sigma_{1}}
%}{
%	\tevalms{\ipair{\mu_1}{\mu_2}}{\ipair{\mu_1'}{\mu_2'}}{\Sigma_{0},\Sigma_{1}}
%}
%
%\inferrule{
%	\tevalm{\mu}{\mu'}
...
%}{
%	\tevalms{\iIfEq{\mu_0}{\mu_1}{\mu_2}{\mu_3}}{\iIfEq{\mu_0'}{\mu_1'}{\mu_2'}{\mu_3'}}{\Sigma_{0},\Sigma_{1},\Sigma_{2},\Sigma_{3}}
%}
%
%\inferrule{ }{
