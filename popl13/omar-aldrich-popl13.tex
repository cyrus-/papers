...
%\conferenceinfo{ICFP '12}{Copenhagen, Denmark} 
%\copyrightyear{2012} 
...
\text{type families}				&		&   \pipe   &   \tfam{fam\_name}{\kappa}{\Theta}{\psi} \pipe																	\tfamcase{\psitype}{fam\_name}{\psi_{1}}{\psi_{2}} 
 \\
\text{types} 					& 		& 	\pipe	& 	\ttype{t}{fam\_name}{\psiidx}{\delrep}{\theta} \pipe 
												\tidx{\psitype} 
												\\
...
\text{denotations} 				& 		 & 	\pipe	&	\tden{\mu}{\psitype} \pipe 
												\ttypeof{\psiden} \pipe
												\terr \pipe
												\ttidxcase{\psi}{\kappa}{\psi_{0}}{\psi_{1}}\\
...
\textbf{internal terms} 				& 	\mu	&	::=	&	\mvar{u} \pipe 
												...
												\mfst{\mu} \pipe
												\msnd{\mu} \\
							& 		& 	\pipe	&	\mIfEq{\mu_{0}}{\mu_{1}}{\mu_{3}}{\mu_{4}} \pipe
												\mvalof{\psiden}\\
...
\textbf{kinds} 					& \kappa	&	::=	&	\kvar{$\alpha$} \pipe
												\karrow{\splat{\kappa}{1}{n}}{\kappa} \pipe 
												\kforall{\kvar{$\alpha$}}{\kappa} \pipe
												\kProg \pipe 
												\kstr \pipe 
												\kunit \pipe 
												\kpair{\kappa_{1}}{\kappa_{2}} \pipe 
												\textsc{label} \\
							&		&	\pipe	&	\kType{\kappa} \pipe 
												\kTypeBlur \pipe
												\kOp{n} \pipe 
												\kDenk{\kappa} \pipe 
												\kDen \pipe 
												\kIType\\
%							& \kcasev	&	::=	&	\kcaseZ{\splat{\kappa}{1}{n}} \pipe 
%												\kcaseS{\kcasev}{\kcasev}
\end{array}$$
...
%\begin{mathpar}
%\inferrule{
%	\overbrace{\tentails{\cdot}{\cdot}{\cdot}{\tof{\psiprog}{\kProg}}}^{\text{\small kind checking}}{ }\\
%	\overbrace{\tevals{\psiprog}{\tprog{e}}{\noprob}}^{\text{\small specification normalization}}{ }\\
%	\overbrace{\translates{\cdot}{e}{\mu}{\psiidx}{\kappa}{\psirep}}^{\text{\small verification \& translation}}{ }
%}{
...
%\begin{figure*}
%%\vspace{-0.33in}
%$\fbox{\inferrule{}{\tentails{\mathcal{K}}{\mathcal{L}}{\mathcal{T}}{\tof{\psi}{\kappa}}}}$
%~~~~$\kvarCtx ::= \cdot \pipe \kvarCtx, \kvar{$\alpha$}$
%~~~~$\labelCtx ::= \cdot \pipe \labelCtx, \klabelOf{label}{\kappa}$
...
%	\cdots\\
%	\kentailsX{\kappa_{n}}\\
%  \tentails{\kvarCtx}{\labelCtx}{\tvarCtx, \splatTwo{\tvar{t}}{{:}\kappa}{1}{n}}{\tof{\psi}{\kappa}}
%}{
%  \tentailsXt{\tlam{\splatTwo{\tvar{t}}{{:}\kappa}{1}{n}}{\psi}}{\karrow{\splat{\kappa}{1}{n}}{\kappa}}
%}
%
%\inferrule{
%	\tentails{\kvarCtx, \kvar{$\alpha$}}{\labelCtx}{\tvarCtx}{\tof{\psi}{\kappa}}
%}{
%	\tentailsXt{\tLam{\kvar{$\alpha$}}{\psi}}{\kforall{\kvar{$\alpha$}}{\kappa}}
%}
%
%\inferrule{
...
%
%\inferrule{ }{\tentailsXt{\tunit}{\kunit}}
%
%\inferrule{
%	\tentailsXt{\psi_{1}}{\kappa_{1}}\\
...
%\inferrule{
%	\kentailsX{\kappa}\\
%	\kTypeBlur \text{~strictly positive in~} \kappa\\
%	\tentailsXt{\psiidx}{\kappa}\\
%	\tentailsXt{\psirep}{\kIType}
%}{
%	\tentailsXt{\ttype{\psiidx}{\kappa}{\psirep}}{\kType{\kappa}}
%} \\
%
%\inferrule{
...
%\\
%\inferrule{
%	\entails{\labelCtx~\mvarCtx~\cdot}{\mu}\\
