...
One reason for this gap is because new features and abstractions tend to be distributed within new programming languages. Prominent examples include:
\begin{itemize}
\item UPC, CAF, X10
\item Erlang
\item Cilk
...
This is because they need first-class language and compiler support but monolithic languages cannot be modularly and portably extended (we discuss the difference between language extensions and compiler extensions in Section XX). Unfortunately, writing code in multiple languages poses a host of challenges. Thus, we need a mechanism that allows new primitives to be defined and implemented modularly and distributed with libraries.
