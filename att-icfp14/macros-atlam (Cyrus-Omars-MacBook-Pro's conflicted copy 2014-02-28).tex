...
\newcommand{\ecompilesA}[5]{#1 \vdash_{#2} #3 : #4 \longrightarrow #5}
...
\newcommand{\eCtxTogCtx}[4]{\vdash^{#1}_{#2} #3 \leadsto #4}
\newcommand{\eCtxTogCtxX}[2]{\eCtxTogCtx{\Xi}{\fvalCtx}{#1}{#2}}

\newcommand{\ddbar}[4]{\vdash^{#1}_{#2} #3 \leadsto #4}
