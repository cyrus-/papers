...
\newcommand{\tfold}[6]{{\sf fold}(#1; #2; #3,#4,#5.#6)}
...
\newcommand{\kunit}{{\sf Unit}}
\newcommand{\kpair}[2]{#1 \times #2}
\newcommand{\klist}[1]{{\sf list}[#1]}
\newcommand{\kTypeBlur}{{\sf Ty}}
\newcommand{\kDen}{{\sf D}}
\newcommand{\kIType}{{\sf ITy}}
\newcommand{\kITerm}{{\sf ITm}}
