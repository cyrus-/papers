...
class fn(typy.Fragment):
  ...
  def check_Assign(cls, ctx, stmt):
    ...
    ctx.ana_pat(pat, ty) ^\label{line:ana_pat}^
...
\section{OCaml Examples}\label{sec:ocaml-examples}
\begin{codelisting}[t]
\vspace{-3px}
