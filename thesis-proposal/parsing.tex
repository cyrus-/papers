...
let imageBase : URL = new
  val protocol : URLString = $\text{"}$SUShttpEUS$\texttt{"}$
  val subdomain : URLString = $\texttt{"}$SUSimagesEUS$\texttt{"}$
  (* ... *)
\end{lstlisting}
