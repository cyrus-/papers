...
% Because of the type annotation on the declaration of \lstinline{standardHTML}, we can maintain a typing discipline without needing to reason about the desugaring itself: the term above must have type \lstinline{HTML} (or be ill-formed or ill-typed).
