...
\begin{quote}
\emph{Active types allow developers to extend the compile-time and edit-time semantics of a programming system  from within libraries in a safe and practical manner.
}
\end{quote}
\end{abstract}
