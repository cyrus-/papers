...
\title{Type-Oriented Foundations for\\ Extensible Programming Systems\\\vspace{10px}\large{{PhD Thesis Proposal}}}
\author{Cyrus Omar\\
...
\begin{quote}
\emph{Active types allow providers to extend a programming system with new compile-time and edit-time features   from within libraries in a safe and expressive manner.
}
\end{quote}
\end{abstract}
%\newpage
