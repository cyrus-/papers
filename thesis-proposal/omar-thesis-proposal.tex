...
\begin{quote}
\emph{``Active types'' allow abstraction providers to extend a programming system with new notations, strengthen its type system and implement specialized editor services from within in a safe and expressive manner.}
\end{quote}
\end{abstract}
%\newpage
