...
\begin{quote}
{Typed programming systems can be made more expressive by incorporating \emph{extension mechanisms} that allow library providers to introduce new syntax, type system fragments and editor services. The code that extensions generate can be validated to preserve key metatheoretic properties, and to guarantee that extensions can be reasoned about separately and composed arbitrarily.}
\end{quote}
