...
\title{Safely Extending Typed Programming Systems From Within\\\vspace{10px}\large{{PhD Thesis Proposal}}}
\author{Cyrus Omar\\
...
\begin{quote}
\emph{\textbf{Active types} allow abstraction providers to extend a programming system with new notations, strengthen its type system and implement specialized editor services from within libraries in a safe and expressive manner.}
\end{quote}
\end{abstract}
%\newpage
