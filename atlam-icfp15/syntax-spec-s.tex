...
%%%%%%
  \newcommand{\istype}[2]{#1~\mathtt{type}_{#2}}
  ...
  \newcommand{\sofkVX}[2]{\sofk{\emptyset}{\emptyset}{\Phi}{#1}{#2}}
  \newcommand{\sofkVXz}[2]{\sofkz{\emptyset}{\emptyset}{\Phi}{#1}{#2}}
  \newcommand{\serr}[2]{#1~\mathtt{err}_{#2}}
  \newcommand{\serrX}[1]{\serr{#1}{\aCtx}}
  \newcommand{\serrA}[1]{\serr{#1}{\argEnv}}
  ...
  \newcommand{\sstepA}[2]{\sstep{#1}{\argEnv}{#2}}
  ...
  \newcommand{\svalA}[1]{\sval{#1}{\argEnv}}
  ...
  \newcommand{\tccsigok}[1]{\vdash #1~\mathtt{sigsok}}

  \newcommand{\otherc}[2]{\keyw{other}[#1; #2]}

  \newcommand{\qstep}[2]{\sstepA{\sqitm{#1}}{\sqitm{#2}}}
  \newcommand{\qval}[1]{\svalA{\sqitm{#1}}}
  \newcommand{\qerr}[1]{\serrA{\sqitm{#1}}}
  \newcommand{\qtstep}[2]{\sstepA{\sqity{#1}}{\sqity{#2}}}
  \newcommand{\qtval}[1]{\svalA{\sqity{#1}}}
  \newcommand{\qterr}[1]{\serrA{\sqity{#1}}}

  \newcommand{\tytrans}[3]{\vdash_{#1} #2~\mathtt{type} \leadsto #3}
  \newcommand{\tytransX}[2]{\tytrans{\Phi}{#1}{#2}}
  \newcommand{\ctxtrans}[3]{\vdash_{#1} #2~\mathtt{ctx} \leadsto #3}
  \newcommand{\ctxtransX}[2]{\ctxtrans{\Phi}{#1}{#2}}

  \newcommand{\tytsv}[3]{\vdash_{#1}^{#2} #3}
  \newcommand{\tytsvX}[1]{\tytsv{\Phi}{c}{#1}}
  \newcommand{\tmtsv}[4]{\vdash_{#1}^{#2} #3~#4}
  \newcommand{\tmtsvX}[2]{\tmtsv{\es; \Upsilon; \Phi}{c}{#1}{#2}}

  \newcommand{\bprj}[4]{{}^{m}\mathcal{B}_{#1}^{#2}(#3)=#4}
  \newcommand{\bprjX}[2]{\bprj{\Phi'}{\tc'}{#1}{#2}}
  \newcommand{\bprje}[6]{\bprj{#1}{#2}{#3 \vdash #4 : #5}{#6}}
  \newcommand{\bprjeX}[3]{\bprje{\Phi'}{\tc'}{\Upsilon}{#1}{#2}{#3}}
% static terms
% \sx
% raise
% lam
