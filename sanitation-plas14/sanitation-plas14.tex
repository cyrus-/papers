...
{\tcheck{r}{P} \treduces \tstr{s} \\ s \not \in \lang{r}}
{P \err}
\end{mathpar}
\caption{Big step semantics for the target lanugage.
There are also unimplemented error propagation rules for for P-E-Concat and P-E-Subst.}
\label{fig:ieval}
\end{figure}
...
\begin{thm}
  Let $P$ be a term in the target language. If $\sctx \vdash P : \theta$ 
