...
\newcommand{\family}[6]{{\sf family}~\fvar{#1}~{\sf of}~#2~\{#3 : #4 \sim \tvar{#5}.#6\}}
\newcommand{\familyDf}{\family{Fam}{\kappaidx}{\opsort}{\opsigsort}{i}{\tau}}
...
\newcommand{\tfold}[5]{{\sf fold}(#1; #2; \tvar{#3},\tvar{#4}.#5)}
...
\newcommand{\tden}[2]{\llbracket #2 \Longrightarrow #1 \rrbracket}
\newcommand{\ttypeof}[1]{{\sf typeof}~#1}
\newcommand{\tvalof}[2]{{\sf val}(\tden{#1}{#2})}
...
\newcommand{\tops}[5]{\opvar{#1}(\tvar{#3}{:}#2,\tvar{#4}.#5)}
\newcommand{\topp}[2]{#1; #2}
...
\newcommand{\kIType}{\textsf{IType}}
\newcommand{\kITerm}{\textsf{ITerm}}
